...
<?php require "navbar.php"?>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td><img src="image/<?= $pengaduan['foto']?>" style="width:auto;height:200px;"> </td>
      <td><a href="halaman_edit.php?id_pengaduan=<?=$pengaduan['id_pengaduan'];?>" class="btn btn-sm btn-primary ml-auto">Edit</a></td>
